<?php
/**
 * ultra-single-node component for ultrapress
 *
 ...
 */
if ( ! class_exists( 'ultra_Single_Node' ) ) {
class ultra_Single_Node {
	/**
	 * Instance.
	 *
	 ...
	 * @var trigger
	 */
	public static $trigger = 'ultra/ultra_single_node';
	/**
	 * name.
	 *
	 * name of component.
	 ...
	 * @var name
	 */
	public static $name = 'ultra-single-node';
	/**
	 ...
	 * @var description
	 */
	public static $description = 'single node component, used with to unify outputs & in composed components';
	/**
	...
	public function get_component_info() {
		...
		$out1_icon_url = 'img/Button-Download-icon.png';
