 ...
 */
if ( ! class_exists( 'ultra_Get_Option' ) ) {
class ultra_Get_Option {
	/**
	 * Instance.
	 *
	 ...
	 * @var trigger
	 */
	public static $trigger = 'ultra/get_option';
	/**
	 * name.
	 *
	 * name of component.
	 ...
	 * @var name
	 */
	public static $name = 'ultra-get-option';
	/**
	 ...
	 * @var description
	 */
	public static $description = 'get option';
	/**
	...
	public static $accepted_args = array(
		'option' => array(
			...
			'type_of_variable' => 0,
			'required' => 1,
			'description' => '(string) (Required) Name of option to retrieve. Expected to not be SQL-escaped.',
			'name' => 'option',
		),
		'default' => array(
			'primal' => 0,
			'type_of_variable' => 0,
			'required' => 0,
			'description' => '(mixed) (Optional) Default value to return if the option does not exist. Default value: empty string ""',
			'name' => 'default value',
		),
	);
	/**
	...
	public static $outputs = array(
		'/success' => array(
			'description' => 'get option success',
			'name' => 'success',
			'args' => array(
				'value' => array(
					'type_of_variable' => '',
					'description' => 'value of option',
					'name' => 'value of option',
				),
			),
		),
		'/fail' => array(
	...
	public function run($ultra_args) {
		...
		$res = get_option( $args['option'], $args['default']);
