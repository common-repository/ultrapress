...
if ( ! class_exists( 'ultra_Notify_Admin_By_Email' ) ) {
class ultra_Notify_Admin_By_Email {
	/**
	 * Instance.
	 *
	 ...
	 * @var trigger
	 */
	public static $trigger = 'ultra/notify_admin_by_email'; 
	/**
	 * name.
	 *
	 * name of component.
	 ...
	 * @var name
	 */ 
	public static $name = 'ultra-notify-admin-by-email'; 
	/**
	 ...
	 * @var description
	 */
	public static $description = 'notify admin by email'; 
	/**
	...
	public static $accepted_args = array(
		'sender_name' => array(
			...
			'type_of_variable' => 0,
			'required' => 0,
			'description' => '(string) name of the email author. only work if <from> is set. defaut is: Wordpress notification',   // description of arg
		),
		'from' => array(
			'primal' => 1,
			'type_of_variable' => 0,
	...
	public function get_component_info() {
		...
		$icon_url =  'img/Apps-Notifications-icon.png';
	...
	public function run($ultra_args) {
		...
		if (array_key_exists('sender_name', $args)) {
			...
			$sender_name =  'Wordpress notification';
		}
...
ultra_Notify_Admin_By_Email::instance();