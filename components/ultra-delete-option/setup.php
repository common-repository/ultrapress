 ...
 */
if ( ! class_exists( 'ultra_Delete_Option' ) ) {
class ultra_Delete_Option {
	/**
	 * Instance.
	 *
	 ...
	 * @var trigger
	 */
	public static $trigger = 'ultra/delete_option';
	/**
	 * name.
	 *
	 * name of component.
	 ...
	 * @var name
	 */
	public static $name = 'ultra-delete-option';
	/**
	 ...
	 * @var description
	 */
	public static $description = 'delete option';
	/**
	...
	public static $accepted_args = array(
		'option' => array(
			...
			'type_of_variable' => 0,
			'required' => 1,
			'description' => '(string) (Required) Name of option to remove. Expected to not be SQL-escaped.',
			'name' => 'delete option',
		),
	);
	/**
	...
	public static $outputs = array(
		'/success' => array(
			'description' => 'option deleted successifully',
			'name' => 'success',
			'args' => array(),
		),
		'/fail' => array(
	...
	public function get_component_info() {
		...
		$icon_url = 'img/13553642.jpg';
		$success_icon_url = 'img/_3-_wx3E_400x400.jpg';
	    $fail_icon_url = 'img/13553642.jpg';
	...
	public function run($ultra_args) {
		...
		$res = delete_option( $args['option'] );
	if ( $res ) {
		// option deleted successifully		
		$args_success = array();
